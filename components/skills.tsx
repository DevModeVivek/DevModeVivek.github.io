...
const skillCategories = [
  { title: "AI & Agentic Systems", skills: [{ name: "Applied AI", icon: SiPython, color: "#3776AB" }, { name: "Agentic AI", icon: SiPython, color: "#F2C94C" }, { name: "Claude", icon: SiPython, color: "#D97757" }, { name: "AI Tooling", icon: SiGit, color: "#A3A3A3" }, { name: "Prompt Workflows", icon: SiPython, color: "#3776AB" }, { name: "AI-assisted Development", icon: SiGit, color: "#A3A3A3" }] },
